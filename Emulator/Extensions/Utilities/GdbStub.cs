    ...
    public class GdbStub : IDisposable, IExternal
    {
        ...
        private void OnHalted(HaltArguments args)
        {
            ...
            case HaltReason.Breakpoint:
                ...
                case BreakpointType.ReadWatchpoint:
                    beforeCommand += cmd =>
                    {
                        ...
                        {
                            SendPacket(new Packet(PacketData.StopReply(5)));
                            beforeCommand = null;
                            commandsCounter = 0;
                            return true;
                        }
            ...
            case HaltReason.Abort:
                SendPacket(new Packet(PacketData.AbortReply(5)));
                return;
            default:
        ...
        private void SendPacket(Packet packet)
        {
            ...
            foreach(var xb in packet.GetCompletePacket())
            {
                terminal.SendByte(xb);
            }
        }
